...
from application.forms import MailingAddForm, ClientAddForm, SettingsAddForm, SettingsManagerForm
from application.models import MailingMessage, Client, MailingSettings
...
def settings_toggle_active(request, pk):
    ...
    mailing_item.save()
    return redirect(reverse('application:settings_home'))
...
class ClientCreateView(CreateView):
    ...
    success_url = reverse_lazy('application:client_home')
...
class SettingsCreateView(CreateView):
    ...
    success_url = reverse_lazy('application:settings_home')
